...
from tournament.views import PlayerView, TournamentTncView, TournamentListView, TournamentDetailsView, TeamsByCategoryView
...
urlpatterns = [
    ...
    path('teams/', TeamsByCategoryView.as_view(), name='teams-by-category'),
]